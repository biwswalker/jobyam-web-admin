...
import { createDocument } from '../../services/preparedocuments';
interface Template {
    id: string;
    name: string;
}
...
export default function CreateDocument() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response && response.code === 201) {
                ...
                const errorMessage = response?.message || t('createDocumentFailed', language);
    ...
    useEffect(() => {
        const fetchTemplates = async () => {
            try {
                const response = await api.get('master/template/plans/select');
                        ...
                        {filePreview && (
                            <div className="mt-2">
                                ...
                                <img
                                    ...
                                    className="max-h-40 max-w-full rounded-md border border-gray-200"
                                />
                            </div>
                        )}
                    ...
                    <div className="bg-white rounded-lg p-6 max-w-sm w-full mx-4">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-gray-500 mb-6">
                                {t('documentCreatedSuccessfully', language)}
                            </p>
                            <button
                                type="button"
                                onClick={() => navigate('/preparedocuments')}
